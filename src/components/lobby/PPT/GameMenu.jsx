...
import styles from '../../styles/PPT/Menu.module.css';
...
const GameMenu = ({ onSelectMode }) => {
  ...
  const handlePlayGuest = () => {
    playSelectedSound();
    if (selecting === 'single') {
      onSelectMode('single', { player1: null });
    } else {
      onSelectMode('multi', { player1: null, player2: null });
    }
    setSelecting(null);
  };
  ...
  const handlePlay = () => {
    if (selecting === 'single') {
      ...
      playSelectedSound();
      onSelectMode('single', { player1: player1Name.trim() });
    } else {
      ...
      playSelectedSound();
      onSelectMode('multi', { player1: player1Name.trim(), player2: player2Name.trim() });
    }
    setSelecting(null);
  };
      ...
      <div className={styles.gameMenu}>
        <div className={styles.menuContainer}>
          <div className={styles.Titles}>
            <h1 className={styles.gameTitle}><span>Piedra Papel Tijeras</span></h1>
            <h2 className={styles.gameSubtitle}>Vegeta contra Gokú</h2>
          </div>
          ...
          <div className={styles.GogetaMenu} />
        </div>
      </div>
    </div>
  );
